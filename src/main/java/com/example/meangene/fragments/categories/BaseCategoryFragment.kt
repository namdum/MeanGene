...
import com.example.meangene.databinding.FragmentBaseCategoryBinding
import com.example.meangene.util.showBottomNavigationView

open class BaseCategoryFragment: Fragment(R.layout.fragment_base_category) {

    private lateinit var binding: FragmentBaseCategoryBinding
    protected val offerAdapter: BaseProductAdapter by lazy { BaseProductAdapter() }
    protected val  bestProductsAdapter: BaseProductAdapter by lazy { BaseProductAdapter() }
